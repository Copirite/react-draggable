...
function positionToCSSTransform(style) {
  ...
  var rotation = " rotate(" + style.rotation + "deg)";

	style.transform = 'translate(' + x + ',' + y + ')' + rotation;
	style.WebkitTransform = 'translate(' + x + ',' + y + ')' + rotation;
	style.OTransform = 'translate(' + x + ',' + y + ')' + rotation;
	style.msTransform = 'translate(' + x + ',' + y + ')' + rotation;
	style.MozTransform = 'translate(' + x + ',' + y + ')' + rotation;
	delete style.left;
	delete style.top;
	return style;
}
...
module.exports = React.createClass({
	...
	componentWillReceiveProps: function(nextProps) {
        ...
        clientRotation: nextProps.start.rotation
			});
		}
	},
	...
	getInitialState: function () {
		return {
			...
			clientX: this.props.start.x, clientY: this.props.start.y, clientRotation: this.props.start.rotation
		};
	},
	...
	render: function () {
      ...
      rotation: this.state.clientRotation
		};
